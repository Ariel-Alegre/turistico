...
<p
    ...
    por persona
        ...
        <div className="text-center">
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Aún no hay publicaciones.</h1>
          <p className="mt-6 text-base leading-7 text-gray-600">Sé el primero en publicar, regístrate y publica la primera publicación.</p>
